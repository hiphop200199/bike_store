...
<label for="login" class="login">登入</label>
      ...
      <input type="text" class="register-related" placeholder="請輸入姓名..." required maxlength="255" />
      ...
      <input
        ...
        minlength="8"
      />
      <input type="tel" class="register-related"  required placeholder="請輸入電話..." />
      <input type="text" class="register-related"  required placeholder="請輸入送貨地址..." />
      <p class="message" ></p>
      <div id="buttons">
